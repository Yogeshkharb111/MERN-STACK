...
recipes.forEach(({ name, image, cuisine, rating, servings }) => {
    ...
    // Append and attach event listener
    parentElem.appendChild(newDiv);

    // Add listener for the last button in the newDiv
    const button = newDiv.querySelector(".popup-btn");
    button.addEventListener("click", () => handleCardClick(popupData));
});
